			...
			method hx-attrs(
				...
				*%pars,
				...
				[
					...
					|("hx-push-url='{ fmt($push_url) }'"    with $push_url   ),
					|("hx-replace-url='{ fmt($replace_url) }'" with $replace_url),
					|("hx-select='$_'"         with $select       ),
					|("hx-select-oob='$_'"     with $select_oob   ),
					|("hx-swap='$_'"           with $swap         ),
					|("hx-vals='$_'"           with $vals         ),
					|("hx-headers='$_'"        with $headers      ),
					|("hx-disable='true'"      if   $disable      ),
					|("hx-disabled-elt='$_'"   with $disabled_elt ),
					|("hx-disinherit='$_'"     with $disinherit   ),
					|("hx-encoding='$_'"       with $encoding     ),
					|("hx-ext='$_'"            with $ext          ),
					|("hx-history='$_'"        with $history      ),
					|("hx-history-elt='$_'"    with $history_elt  ),
